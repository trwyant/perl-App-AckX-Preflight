package App::AckX::Preflight::Syntax::Lua;
...
require App::AckX::Preflight::Syntax::_cc_like;
...
__PACKAGE__->__handles_type_mod( qw{ set lua } );
...
App::AckX::Preflight::Syntax::Lua - App::AckX::Preflight syntax filter for Lua.
...
L<App::AckX::Preflight|App::AckX::Preflight> to process a Lua file,
...
=item documentation (block comments introduced by C<--[[->)

=item metadata (the shebang line if any)
